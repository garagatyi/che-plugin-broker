...
func TestBroker_StartPublishesErrorOnFetchError(t *testing.T) {
	...
	m.cb.On("PubLog", mock.AnythingOfType("string"))
...
func TestBroker_StartPublishesErrorOnProcessError(t *testing.T) {
	...
	m.cb.On("PubLog", mock.AnythingOfType("string"))
	m.cb.On("PubStarted")
	m.cb.On("PrintPlan", mock.AnythingOfType("[]model.PluginMeta"))
	m.cb.On("CloseConsumers")
...
func TestBroker_StartPublishesResults(t *testing.T) {
	...
	m.cb.On("PubDone", mock.AnythingOfType("string"))
